...
(function (Faust) {
    ...
    var XMLNodeUtils = {
        documentOrderSort: function (a, b) {
            var aNode = a.data['xml:node'].split('/').reverse().map(function (x) {
                return parseInt(x);
            });
            var bNode = b.data['xml:node'].split('/').reverse().map(function (x) {
                return parseInt(x);
            });
            if (bNode[0].length === 0) {
                return 1;
    ...
    Y.extend(AnnotationNode, AdhocNode, {
        ...
        children: function () {
            var ancestorAnnotationCandidates = [this].concat(this.ancestors()).map(function (node) {
                return node.annotation;
            });
            //ancestorAnnotationCandidates = ancestorAnnotationCandidates.push(this.annotation);
            var ancestorAnnotations = ancestorAnnotationCandidates.filter(function (annotation) {
                return annotation;
            });
